...
export default function MainLanding() {
    return(
        <MainContainer>
            <div tw="mt-10 w-1/2 h-3/4">
                <img src={SpaceShip}></img>
            </div>
            <div tw="w-2/3 h-1/4 grid text-center">
                <h1 tw="font-display font-bold w-full h-full text-4xl text-yellow-400">Scroll Less</h1>
                <h1 tw="font-display font-bold w-full h-full text-4xl text-yellow-400">Smile More</h1>
            </div>
        </MainContainer>
    );
};
