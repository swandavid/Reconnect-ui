...
const TopContainer = tw.div`mt-5 grid grid-cols-11 place-items-center`;
const TopLogo = tw.img`select-none w-20 h-20`;
const TaskContainer = tw.div`grid grid-cols-10 place-items-center col-start-6`;
const CoundownTimer = tw.text`select-none font-display font-semibold text-xl col-span-1 col-start-1`;
const TaskName = tw.text`select-none font-display font-semibold text-xl col-start-4 col-end-11`;
const LogoutAndProfile = tw.div`grid grid-cols-2 place-items-center col-start-10`;
...
const Emoji = tw.img`select-none flex-none p-4`;
const ProgressBar = tw.div`flex-grow bg-gradient-to-l from-green-600 to-red-600 w-64 h-4`;
